...
const DISHES: DishCreation[] = [
  {
    ...
    brand: "GreenChillyz Signature",
    brandTheme: "green",
    color: "#006B2A",
    bgClass: "bg-[#006B2A]",
    description:
      "Aromatic long-grain basmati rice slow-cooked in handi pots with hand-ground spices, saffron, and tender marinated meats.",
    rotation: -3,
  ...
  },
  {
    id: 2,
    name: "Flame Tandoori",
    brand: "GreenChillyz Tandoor",
    brandTheme: "red",
    color: "#C62828",
    bgClass: "bg-[#C62828]",
    description:
      "Sizzling chicken and paneer tandoori marinated in dark mustard oil, curd, and secret spices, charred to smoky perfection over clay ovens.",
    rotation: -1.5,
    polygon: "polygon(8% 0%, 100% 15%, 92% 100%, 0% 85%)",
    image: "/assets/food/tandoori_signature.png",
  },
  {
    id: 3,
    name: "Smoky Kebabs",
    brand: "GreenChillyz Grill",
    brandTheme: "gold",
    color: "#C9A227",
    bgClass: "bg-[#C9A227]",
    description:
      "Melt-in-mouth seekh and tikka kebabs hand-skewered and flame-roasted over live embers for an authentic street-to-table finish.",
    rotation: 2.5,
    polygon: "polygon(15% 15%, 100% 0%, 85% 85%, 0% 100%)",
    image: "/assets/food/kebabs_signature.png",
  },
  {
    id: 4,
    name: "Signature Kathi Rolls",
    brand: "GreenChillyz Express",
    brandTheme: "green",
    color: "#006B2A",
    bgClass: "bg-[#006B2A]",
    description:
      "Iconic Kolkata-style egg-chicken and paneer Kathi rolls wrapped in flaky, golden parathas with fresh onion rings and tangy green chutney.",
    rotation: -2,
  ...
  {
    id: 5,
    name: "Wok Chinese Specials",
    brand: "GreenChillyz Wok",
    brandTheme: "red",
    color: "#C62828",
    bgClass: "bg-[#C62828]",
    description:
      "Fiery Schezwan noodles, crunchy chilli paneer, and garlic Manchurian classics tossed over high flame in traditional woks.",
    rotation: 2,
    polygon: "polygon(0% 10%, 90% 0%, 100% 90%, 10% 100%)",
    image: "/assets/food/chinese_signature.png",
  },
];
