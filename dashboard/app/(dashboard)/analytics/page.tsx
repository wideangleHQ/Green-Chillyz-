    ...
    <div className="flex flex-col gap-6 select-none text-xs">
        ...
        {overviewLoading ? (
          ...
          <div className="grid grid-cols-2 md:grid-cols-6 gap-4 text-center">
            ...
            <div className="p-4 rounded-xl border border-[var(--border)]/10 bg-[var(--surface)] shadow-soft">
              ...
              <span className="text-lg font-bold text-[var(--color-primary)] block mt-1">+{overview.walletCredits.total}</span>
            </div>
            <div className="p-4 rounded-xl border border-[var(--border)]/10 bg-[var(--surface)] shadow-soft">
            ...
            <div className="p-4 rounded-xl border border-[var(--border)]/10 bg-[var(--surface)] shadow-soft">
              ...
              <span className="text-lg font-bold text-[var(--color-primary)] block mt-1">{overview.voucherRedemptions}</span>
            </div>
            <div className="p-4 rounded-xl border border-[var(--border)]/10 bg-[var(--surface)] shadow-soft">
              <span className="text-[9px] text-[var(--text-muted)] font-semibold uppercase tracking-wider block">Games Played</span>
              <span className="text-lg font-bold text-blue-600 block mt-1">{overview.gamePlays}</span>
            </div>
            <div className="p-4 rounded-xl border border-[var(--border)]/10 bg-[var(--surface)] shadow-soft">
              <span className="text-[9px] text-[var(--text-muted)] font-semibold uppercase tracking-wider block">Alerts Dispatched</span>
              <span className="text-lg font-bold text-purple-600 block mt-1">{overview.notifications}</span>
            </div>
          </div>
        ) : null}
      </section>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <section className="p-6 rounded-2xl border border-[var(--border)]/10 bg-[var(--surface)] shadow-soft flex flex-col gap-4">
          ...
          {isSeriesLoading ? (
            <div className="h-[150px] bg-[var(--surface-hover)] rounded animate-pulse" />
          ) : activeSeries ? (
