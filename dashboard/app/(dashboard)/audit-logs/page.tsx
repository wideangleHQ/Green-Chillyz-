        ...
        {isLoading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-[var(--border)]/15 text-[var(--text-muted)] font-semibold bg-[var(--background)]">
        ...
        <div className="fixed inset-0 z-9999 flex items-center justify-center p-4 select-none">
          ...
          <div className="relative max-w-lg w-full bg-[var(--surface)] border border-[var(--border)] rounded-2xl shadow-heavy p-6 flex flex-col gap-4 text-xs">
            <div className="flex items-center justify-between border-b border-[var(--border)]/10 pb-2">
              ...
              <button onClick={() => setSelectedLog(null)} className="p-1 rounded hover:bg-[var(--surface-hover)] text-[var(--text-muted)]">
                <X className="w-4 h-4" />
              </button>
            </div>
