      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_0.7fr] gap-6">
        ...
        <section className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {listLoading ? (
              <div className="h-40 bg-zinc-100 dark:bg-zinc-800 rounded-2xl animate-pulse w-full col-span-2" />
                ...
                >
                  ...
                  <div className="mt-auto pt-3 border-t border-[var(--border)]/5 flex items-center justify-between text-[10px] text-[var(--text-muted)]">
                    ...
                    <button
                      ...
                      className={`px-2 py-1 rounded flex items-center gap-1 font-bold tracking-wide uppercase hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors ${
        ...
        <div className="fixed inset-0 z-9999 flex items-center justify-center p-4">
          ...
          >
            <div className="flex items-center justify-between border-b border-[var(--border)]/10 pb-2">
              ...
              <button type="button" onClick={() => setCreateOpen(false)} className="p-1 rounded hover:bg-zinc-100 dark:hover:bg-zinc-800 text-[var(--text-muted)]">
                <X className="w-4 h-4" />
              </button>
            </div>
