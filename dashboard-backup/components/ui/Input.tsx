      ...
      <div className="relative w-full flex flex-col gap-1">
        <div className="relative w-full">
          <input
            ...
            className={`peer w-full px-4 pt-5 pb-2 text-sm text-[var(--foreground)] bg-[var(--input-bg)] border border-[var(--border)] rounded-lg transition-all duration-200 outline-none focus:border-[var(--border-focus)] focus:ring-1 focus:ring-[var(--border-focus)] ${
              isPassword ? 'pr-11' : ''
        ...
        {capsLockActive && isPassword && (
          <div
            ...
            role="status"
            aria-live="polite"
            className="text-[10px] font-medium text-amber-600 dark:text-amber-400 mt-0.5"
          >
            Caps Lock is active
          </div>
        )}
